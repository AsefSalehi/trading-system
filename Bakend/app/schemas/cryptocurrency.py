...
class CryptocurrencyCreate(CryptocurrencyBase):
    ...
    circulating_supply: Optional[Decimal] = Field(
        None, description="Circulating supply"
    )
...
class Cryptocurrency(CryptocurrencyBase):
    ...
    price_change_percentage_24h: Optional[Decimal] = Field(
        None, description="24h price change percentage"
    )
    price_change_percentage_7d: Optional[Decimal] = Field(
        None, description="7d price change percentage"
    )
    price_change_percentage_30d: Optional[Decimal] = Field(
        None, description="30d price change percentage"
    )
...
class PriceHistory(PriceHistoryBase):
    ...
    total_volume: Optional[Decimal] = Field(
        None, description="Trading volume at the time"
    )
