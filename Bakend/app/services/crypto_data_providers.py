        ...
        for coin in data:
            try:
                normalized_coin = {
                    ...
                    "name": coin.get("name", ""),
                    "slug": coin.get("id", ""),
                    "current_price": Decimal(str(coin.get("current_price", 0))) if coin.get("current_price") else None,
                    "market_cap": Decimal(str(coin.get("market_cap", 0))) if coin.get("market_cap") else None,
                    "market_cap_rank": coin.get("market_cap_rank"),
                    "total_volume": Decimal(str(coin.get("total_volume", 0))) if coin.get("total_volume") else None,
                    ...
                    "price_change_24h": Decimal(str(coin.get("price_change_24h", 0))) if coin.get("price_change_24h") else None,
                    "price_change_percentage_24h": Decimal(str(coin.get("price_change_percentage_24h", 0))) if coin.get("price_change_percentage_24h") else None,
                    "price_change_percentage_7d": Decimal(str(coin.get("price_change_percentage_7d_in_currency", 0))) if coin.get("price_change_percentage_7d_in_currency") else None,
                    "price_change_percentage_30d": Decimal(str(coin.get("price_change_percentage_30d_in_currency", 0))) if coin.get("price_change_percentage_30d_in_currency") else None,
                    "ath": Decimal(str(coin.get("ath", 0))) if coin.get("ath") else None,
                    "ath_date": datetime.fromisoformat(coin.get("ath_date", "").replace("Z", "+00:00")) if coin.get("ath_date") else None,
                    "atl": Decimal(str(coin.get("atl", 0))) if coin.get("atl") else None,
                    "atl_date": datetime.fromisoformat(coin.get("atl_date", "").replace("Z", "+00:00")) if coin.get("atl_date") else None,
                    "image_url": coin.get("image", ""),
                    "last_updated": datetime.fromisoformat(coin.get("last_updated", "").replace("Z", "+00:00")) if coin.get("last_updated") else datetime.utcnow()
                }
                normalized.append(normalized_coin)
            except Exception as e:
                logger.error(f"Error normalizing coin data for {coin.get('id', 'unknown')}: {e}")
                continue
    ...
    def _normalize_coin_data(self, data: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "current_price": Decimal(str(market_data.get("current_price", {}).get("usd", 0))) if market_data.get("current_price", {}).get("usd") else None,
                "market_cap": Decimal(str(market_data.get("market_cap", {}).get("usd", 0))) if market_data.get("market_cap", {}).get("usd") else None,
                "market_cap_rank": market_data.get("market_cap_rank"),
                "total_volume": Decimal(str(market_data.get("total_volume", {}).get("usd", 0))) if market_data.get("total_volume", {}).get("usd") else None,
                ...
                "last_updated": datetime.fromisoformat(market_data.get("last_updated", "").replace("Z", "+00:00")) if market_data.get("last_updated") else datetime.utcnow()
            }
        except Exception as e:
        ...
        for coin in data:
            try:
                ...
                normalized_coin = {
                    ...
                    "name": coin.get("name", ""),
                    "slug": coin.get("slug", ""),
                    "current_price": Decimal(str(quote.get("price", 0))) if quote.get("price") else None,
                    ...
                    "total_supply": Decimal(str(coin.get("total_supply", 0))) if coin.get("total_supply") else None,
                    "max_supply": Decimal(str(coin.get("max_supply", 0))) if coin.get("max_supply") else None,
                    "price_change_24h": Decimal(str(quote.get("percent_change_24h", 0))) if quote.get("percent_change_24h") else None,
                    "price_change_percentage_24h": Decimal(str(quote.get("percent_change_24h", 0))) if quote.get("percent_change_24h") else None,
                    "price_change_percentage_7d": Decimal(str(quote.get("percent_change_7d", 0))) if quote.get("percent_change_7d") else None,
                    "price_change_percentage_30d": Decimal(str(quote.get("percent_change_30d", 0))) if quote.get("percent_change_30d") else None,
                    "last_updated": datetime.fromisoformat(quote.get("last_updated", "").replace("Z", "+00:00")) if quote.get("last_updated") else datetime.utcnow()
                }
                normalized.append(normalized_coin)
            except Exception as e:
                logger.error(f"Error normalizing coin data for {coin.get('symbol', 'unknown')}: {e}")
                continue
    ...
    def _normalize_coin_data(self, data: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "total_volume": Decimal(str(quote.get("volume_24h", 0))) if quote.get("volume_24h") else None,
                "circulating_supply": Decimal(str(data.get("circulating_supply", 0))) if data.get("circulating_supply") else None,
