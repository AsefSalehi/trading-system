...
class TestCryptocurrencyService:
    ...
    @pytest.mark.asyncio
    async def test_fetch_and_store_listings_success(self, service, mock_db_session, sample_crypto_data):
    ...
    @pytest.mark.asyncio
    async def test_fetch_and_store_listings_update_existing(self, service, mock_db_session, sample_crypto_data):
    ...
    @pytest.mark.asyncio
    async def test_fetch_and_store_listings_provider_error(self, service, mock_db_session):
    ...
    @pytest.mark.asyncio
    async def test_get_cryptocurrency_by_symbol_not_found(self, service, mock_db_session):
    ...
    @pytest.mark.asyncio
    async def test_create_cryptocurrency_success(self, service, mock_db_session, sample_crypto_data):
        """Test successful cryptocurrency creation"""
        result = await service._create_cryptocurrency(mock_db_session, sample_crypto_data)
    ...
    async def test_update_cryptocurrency(self, service, sample_crypto_data):
        ...
        await service._update_cryptocurrency(Mock(), existing_crypto, sample_crypto_data)
        
        assert existing_crypto.current_price == sample_crypto_data["current_price"]
        assert existing_crypto.market_cap == sample_crypto_data["market_cap"]
    
    @pytest.mark.asyncio
    async def test_store_price_history(self, service, mock_db_session, sample_crypto_data):
    ...
    @pytest.mark.asyncio
    async def test_database_error_handling(self, service, mock_db_session, sample_crypto_data):
